...
const techCategories = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: 'Android', icon: '🤖', description: 'Native Android development' },
    ]
  },
  {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {category.technologies.map((tech, techIndex) => (
                  <motion.div
                    ...
                    className="group bg-card/50 rounded-lg p-4 border border-border hover:border-accent/50 transition-all duration-300 cursor-pointer"
                  >
                    {/* Tech Icon */}
                    ...
                    {/* Tech Name */}
                    <h4 className="font-semibold text-white mb-2 group-hover:text-accent transition-colors duration-200">
                      {tech.name}
                    </h4>
        ...
        >
          <div className="glass-card rounded-xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-white/80 mb-6">
              Our team stays current with the latest technologies. 
              If you have specific requirements, we're ready to adapt.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
